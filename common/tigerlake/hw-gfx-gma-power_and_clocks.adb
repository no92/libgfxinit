...
package body HW.GFX.GMA.Power_And_Clocks is
   ...
   package Rep is
      function PW_Index (PW : PW_Domain) return natural
         with Post => PW_Index'Result < PW5'Enum_Rep - PW1'Enum_Rep + 1;
      function DDI_Index (DDI : DDI_Domain) return natural
         with Post => DDI_Index'Result < DDI_USBC6'Enum_Rep - DDI_A'Enum_Rep + 1;
      function AUX_Index (AUX : AUX_Domain) return natural
         with Post => Aux_Index'Result < AUX_USBC6'Enum_Rep - AUX_A'Enum_Rep + 1;
   end Rep;
